...
var CalendarWidget = class {
    ...
    draw(cr, cx, cy, size) {
        ...
        layoutHeader.set_font_description(Pango.FontDescription.from_string(`Sans Bold ${Math.floor(12 * scale)}`));
        layoutHeader.set_text(headerText, -1);
        cr.moveTo(x + (20 * scale), y + (15 * scale));
        ...
        numLayout.set_font_description(Pango.FontDescription.from_string(`Sans ${Math.floor(10 * scale)}`));
