...
var ClockWidget = class {
    draw(cr, width, height, accentColor, gridWidth, gridHeight) {
        ...
        if (gridWidth === 4 && gridHeight === 2) {
            // Draw premium stacked digital clock on the left side and date on the right side
            ...
            // Draw Analog Clock on the right side
            ...
            // Draw Analog Clock (standard 2x2 and 4x4 layout)
